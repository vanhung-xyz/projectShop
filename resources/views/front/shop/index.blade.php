                            ...
                            <div class="col-lg-7 col-md-7">
                                ...
                                <div class="select-option">
                                    <select name="sort_by" class="sorting" onchange="this.form.submit();">
                                        ...
                                        <option {{ request('sort_by') == 'price-ascending' ? 'selected' : '' }} value="price-ascending">Sorting: Ascending</option>
                                        <option {{ request('sort_by') == 'price-descending' ? 'selected' : '' }} value="price-descending">Sorting: Descending</option>
                                    </select>
                                ...
                                <div class="product-item">
                                    <div class="pi-pic">
                                        ...
                                        <ul>
                                            ...
                                            <li class="quick-view"><a href="shop/product/{{ $product->id}}">+ Quick</a></li>
